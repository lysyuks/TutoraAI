...
export const translations = {
  en: {
    ...
    hero: {
      ...
      description: 'Technical Product Manager with deep expertise in AI, blockchain, legal tech, and supply-chain domains. 14+ years delivering high-impact products for enterprises and startups.',
  ...
  ua: {
    ...
    // Hero
    hero: {
      tagline: 'ІНЖЕНЕРНА ДОСКОНАЛІСТЬ ДЛЯ СВІТУ МАЙБУТНЬОГО',
      title: 'Продакт-менеджер | Керівник вищого рівня',
      description: 'Технічний продакт-менеджер з глибокою експертизою в AI, блокчейні, legal tech та supply-chain. 14+ років створення високоефективних продуктів для підприємств та стартапів.',
