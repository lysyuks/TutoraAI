...
export const translations = {
  ...
  ua: {
    ...
    hero: {
      ...
      description: 'Продакт-менеджер з глибокою експертизою в AI, блокчейні, legal tech та supply-chain. 14+ років створення високоефективних продуктів для підприємств та стартапів.',
