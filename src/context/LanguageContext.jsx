    ...
    experience: {
      ...
      jobs: [
        ...
        },
        {
          ...
          highlight: '1,000+ інженерів',
          description: [
            'Керував продуктом Design System / Common Component Library, який використовують 1,000+ інженерів',
        ...
        },
        {
          ...
          description: [
            ...
            'Очолив end-to-end міграцію CMS, що відкрила $670M нового річного доходу',
          ],
          technologies: ['AWS', 'Prismic', 'SonarQube', 'Jenkins', 'Jira'],
        },
        {
